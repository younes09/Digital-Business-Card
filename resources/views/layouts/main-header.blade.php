...
{{--							</div>--}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/rose.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/rose.jpg')}}" class=""></div>
											<div class="ml-3 my-auto">
												<h6>{{auth()->user()->name}}</h6><span>Free Member</span>
											</div>
										</div>
									</div>
